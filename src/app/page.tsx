...
import { ParagraphType, ParagraphQuestion, StatusTuple } from './types';
...
// Add study cycle (With options, for example: Pomodoro, Self, etc.)
// Add header that extends when hovered
// Add persistent header when scroll down
...
const Question: FC<QProps> = ({ question, paragraphIndex, status, evaluate, onChange, onAffect }) => {
